...
namespace Tests
{
    public class WindowManager_Tests
    {
        ...
        public void Test_GetVisibleWindows()
        {
            ...
            WindowInfo info = new WindowInfo((IntPtr)3, 0, 0, 400, 400, "Test-Title", false, false, false);
        ...
        public void Test_GetCorrectWindowsOrder()
        {
            ...
            var expectedList = new List<WindowInfo>();
            expectedList.Add(new WindowInfo((IntPtr)1, 0, 500, 400, 400, "Third", false, false,false));
            expectedList.Add(new WindowInfo((IntPtr)2, 0, 100, 400, 400, "Second", false, false,false));
            expectedList.Add(new WindowInfo((IntPtr)3, 0, 0, 400, 400, "First", false, false, false));
        ...
        public void Test_Swap()
        {
            ...
            var expectedList = new List<WindowInfo>();
            expectedList.Add(new WindowInfo((IntPtr)2, 0, 0, 400, 400, "", true, false, false));
            expectedList.Add(new WindowInfo((IntPtr)1, 400, 0, 800, 400, "", true, false, false));
            expectedList.Add(new WindowInfo((IntPtr)3, 800, 0, 1200, 400, "", true, false, false));

            var mockList = new List<WindowInfo>();
            mockList.Add(new WindowInfo((IntPtr)3, 0, 0, 400, 400, "", true, false, false));
            mockList.Add(new WindowInfo((IntPtr)2, 400, 0, 800, 400, "", true, false, false));
            mockList.Add(new WindowInfo((IntPtr)1, 800, 0, 1200, 400, "", true, false, false));
            ...
            mock.Setup(x => x.MoveWindowInvoke(It.IsAny<IntPtr>(),It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<bool>()))
                ...
                {
                    result.Add(new WindowInfo(hWnd, X, Y, X + nWidth, Y + nHeight, "", true, false, false));
                    return true;
                });
